...
print(f'100점을 흭득한 학생은 {perfect}명 입니다.')

print(f'55점을 흭득한 학생은{points.index(55) +1}번째 학생입니다.')
print(f'학생 수는 {len(points)}명 입니다.')
print(f'최고점수는 {max(points)}명 입니다.')
print(f'최저점수는 {min(points)}명 입니다.')

#오름차령렬 sort()
print('-' *40)
print(points)
points.sort(reverse=True)
#points.reserse() 정렬이 아니라 단순 역순 배치
print(points)

#리스트 내의 요소의 단순 존재 유무를 확인하려면 in키워드를사용합니다
